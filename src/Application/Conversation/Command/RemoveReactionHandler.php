...
class RemoveReactionHandler
{
    ...
    public function handle(RemoveReactionCommand $command): void
    {
        ...
        // Check if reaction exists (remove missing = no-op)
