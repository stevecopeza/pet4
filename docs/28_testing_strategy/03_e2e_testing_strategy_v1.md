...
- Already referenced in `composer.json` (`test:e2e`) and in the demo contract tests doc (`docs/16_demo/contract_tests.md`)
...
#### 5. Demo System Tests
As specified in `docs/16_demo/contract_tests.md`:
